(function (global, factory) {
    ...
    (global = global || self, factory(global.wbCharts = {}, global.d3));
    ...
    ***************************************************************************** */
    ...
    var CartesianAxis = /** @class */ (function (_super) {
        ...
        CartesianAxis.prototype.updateGrid = function () {
            ...
            var xGrid = d3.axisBottom(this.xScale)
                .ticks(5)
            ...
            var yGrid = d3.axisRight(this.yScale)
                .ticks(5)
                .tickSize(this.width);
    ...
    var Legend = /** @class */ (function () {
        ...
        Legend.prototype.redraw = function () {
            ...
            var enter = entries
                ...
                var chartElement = d3.select(d.selector)
                    .select('path')
                    .node();
                if (chartElement) {
    ...
    var WarningLevels = /** @class */ (function () {
        ...
        WarningLevels.prototype.create = function (axis) {
            ...
            this.warningAxis = d3.axisRight(this.scale)
...
//# sourceMappingURL=wb-charts.umd.js.map
